...
//    std::cout << meta->tree_config->objective_type << std::endl;
  ...
  */
  static double GetLeafSplitGain(double sum_gradients, double sum_hessians, double l1, double l2) {
    ...
    return (reg_abs_sum_gradients * reg_abs_sum_gradients) / (sum_hessians + l2);
...
public:
  ...
  */
  ...
  void DynamicChangeSize(const Dataset* train_data, const TreeConfig* tree_config,
    ...
    for (int i = old_cache_size; i < cache_size; ++i) {
      ...
      /*!
       * ====================================
       * Xixuan: FeatureHistogram created
       * ====================================
       */
      ...
      for (int j = 0; j < train_data->num_features(); ++j) {
        ...
        /*!
         * ====================================
         * Xixuan: FeatureHistogram initialized
         * ====================================
         */

        pool_[i][j].Init(data_[i].data() + offset, &feature_metas_[j],
                         train_data->FeatureBinMapper(j)->bin_type());
